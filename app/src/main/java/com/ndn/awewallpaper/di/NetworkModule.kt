...
import com.ndn.awewallpaper.data.source.remote.api.middleware.InterceptorImpl
import com.ndn.awewallpaper.data.source.remote.api.middleware.RxErrorHandlingCallAdapterFactory
...
fun provideNameApi(retrofit: Retrofit): AweWallpaperApi {
    return retrofit.create(AweWallpaperApi::class.java)
}
