...
object StringUtils {
    ...
    fun setSpannableString(textView: TextView, contentSp: String,
        ...
        spannableString.setSpan(
                ForegroundColorSpan(textView.resources.getColor(R.color.C_6EACEF)),
    ...
    private const val STR_MAX_CHAR_COUNT = 36
    fun formatStringWith36Chars(inputString: String?): String {
        if (inputString.isNullOrBlank()) {
            return ""
        }

        var stringToFormat = inputString
